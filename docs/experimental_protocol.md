...
12. All predictions must fall in the range defined by the [model output](./problem_definition.md); the prediction unit can be converted to \[%\] to represent chance instead of probability.
13. All target labels must align with the defined [labels](./problem_definition.md).